 ...
 * - topDataStructures : chuỗi các CTDL phổ biến nhất, vd "HashMap (4),
 * ArrayList (2)"
 */
public class StudentEvaluation {
    ...
    public String getTopAlgorithms() {
        return topAlgorithms;
    }

    public void setTopAlgorithms(String topAlgorithms) {
        this.topAlgorithms = topAlgorithms;
    }

    public String getTopDataStructures() {
        return topDataStructures;
    }

    public void setTopDataStructures(String topDataStructures) {
    ...
    public void setTotalAnalyzed(int totalAnalyzed) {
